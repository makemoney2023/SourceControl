...
assert_grep "$PACK" "Design before production|Design-before-production" "pack design-before-production gate"
assert_grep "$PACK" "design_brief_path" "pack requires design_brief_path"
assert_grep "$PACK" "email-design" "pack requires email-design before Phase 17 Layer B"
assert_grep "$ROOT/skills/org/positions/lifecycle-marketer/SKILL.md" "Design brief|email/design" "lifecycle requires Design brief"
assert_grep "$ROOT/skills/org/HANDOFF-TEMPLATE.md" "design_brief_path" "HANDOFF-TEMPLATE design_brief_path"
