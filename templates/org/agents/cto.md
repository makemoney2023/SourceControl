...
## First action
1. Read `skills/org/positions/cto/SKILL.md` completely.
...
- Spawn: `tech-lead`, `hardware-engineer`
...
## Artifacts
- ICs: `docs/projects/<active>/business-idea/HANDOFFS/<phase>-cto.md`
- Managers: also `HANDOFFS/<phase>-manager-cto.md`
