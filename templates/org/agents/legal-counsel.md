...
## First action
1. Read `skills/org/positions/legal-counsel/SKILL.md` completely.
...
## Artifacts
- ICs: `docs/projects/<active>/business-idea/HANDOFFS/<phase>-legal-counsel.md`
- Managers: also `HANDOFFS/<phase>-manager-legal-counsel.md`
