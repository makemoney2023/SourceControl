...
## First action
1. Read `skills/org/positions/cfo/SKILL.md` completely.
...
- Spawn: `fpa-analyst`, `fundraising-lead`
...
## Artifacts
- ICs: `docs/projects/<active>/business-idea/HANDOFFS/<phase>-cfo.md`
- Managers: also `HANDOFFS/<phase>-manager-cfo.md`
