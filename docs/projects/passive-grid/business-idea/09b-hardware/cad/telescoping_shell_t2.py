"""TEBS-1 segment T2 (middle) — bayonet lugs at bottom + slots at top."""

from build123d import Align, BuildPart, Cylinder, Locations, Mode, Part
from bayonet_lock import add_bayonet_lug, add_bayonet_slot
from cadpy.assembly import label_shape

DISPLAY_NAME = "Telescoping shell T2 (middle)"
...
def gen_step():
    ...
    return label_shape(seg.part, "t2_middle", "tebs1", "bayonet_lugs_slots", f"od{int(OD_MM)}")
