...
function buildRoutePrompt(utterance: string, spokenBrief: string): string {
  return [
    ...
    "Schema:",
    '{ "intent": "clarify"|"status"|"proceed"|"phase0_restart"|"blockers"|"answer"|"spawn"|"other",',
    ...
    "- answer: operator is supplying answers to a seat's open asks / continuing a needs_input seat (not Phase 0 proceed).",
